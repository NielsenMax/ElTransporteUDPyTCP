...
\title{UDP}
\subtitle{Servicio sin conexión}
\begin{frame}
	\titlepage
\end{frame}
\endgroup
...
\begin{frame}
	\frametitle{Encabezado UPD y aplicacion RTP}
	\includegraphics[width=\textwidth]{EncabezadoUPDYAplicacionRTP}
\end{frame}

\begin{frame}
	\frametitle{Multiplexación}
	\includegraphics[width=\textwidth]{Multiplexacion}
\end{frame}
